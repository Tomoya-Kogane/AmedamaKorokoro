...
{
    // スクロール量の設定
    [Range(0.0f, 1.0f)] public float scrollAmountX;
    [Range(0.0f, 1.0f)] public float scrollAmountY;
    ...
    void Update()
    {
        ...
        gameObject.transform.position = new Vector3(myPos.x + (distance.x * scrollAmountX), myPos.y + (distance.y * scrollAmountY), myPos.z);
    }
}
